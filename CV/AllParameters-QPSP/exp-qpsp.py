...
def evaluate_segmentation(spc_std, spc_potts,
    ...
    # return the negative
    print "params:\tspc_std:" + str(spc_std) + " , spc_potts:" + str(spc_potts) + " , bil_spcstd:" + str(bil_spcstd) + " , bil_colstd:" + str(bil_colstd) + " , bil_potts:" + str(bil_potts) + " , const_1:" + str(const_1) + " , const_2:" + str(const_2) + " , const_1:" + str(const_2) + " , norm_1:" + str(norm_1) + " , norm_2:" + str(norm_2) + " , norm_1:" + str(norm_2)
