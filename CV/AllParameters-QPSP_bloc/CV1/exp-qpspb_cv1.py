...
def generate_segmentation(spc_std, spc_potts, bil_spcstd,
    ...
    results_path = "/home/tomj/Documents/4YP/densecrf/data/CV" + split_no + "/" + dataset + "/bloc_" + experiment_suffix + "/" + exp_path
    try:
...
def evaluate_segmentation(spc_std, spc_potts, bil_spcstd,
                                  bil_colstd, bil_potts,
				const_1,const_2,const_3,
				norm_1, norm_2, norm_3):
    ...
    exp_path = '_'.join(map(str, [spc_std, spc_potts, bil_spcstd,
				...
				const_1,const_2,const_3,
				norm_1, norm_2, norm_3]))
    path_to_results = "/home/tomj/Documents/4YP/densecrf/data/CV" + split_no + "/" + "MSRC/bloc_" + experiment_suffix + "/" + exp_path + "/" + experiment_suffix
