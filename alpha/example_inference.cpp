...
int main(int argc, char* argv[]) {
    ...
    std::string path_to_qpoutput = "/home/rudy/workspace/densecrf/build/res-lrqp.bmp";
    ...
    minimize_LR_QP(path_to_image, path_to_unaries, path_to_qpoutput, path_to_parameters);
}
